...
import { getConnectionRequestById } from 'apiSdk/connection-requests';
...
function ConnectionRequestViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Connection Request Detail View
          </Text>
          {hasAccess('connection_request', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/connection-requests/edit/${data?.id}`} passHref legacyBehavior>
              <Button
